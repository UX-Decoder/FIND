...
class DefaultTrainer(UtilsTrainer, DistributedTrainer):
    ...
    def eval(self, ):
        ...
        if self.opt['WEIGHT'] and os.path.isfile(self.opt['RESUME_FROM']):
            ...
            raise ValueError("Model not found: {}".format(model_path))
    ...
    def train_step(self, batch):
        ...
        if self.is_gradient_accumulation_boundary():
            ...
            if self.opt['FP16'] and not self.opt['FAKE_UPDATE']:
    ...
    def train(self):
        ...
        for epoch in range(self.train_params['start_epoch_idx'], num_epochs):
            ...
            for batch_idx, batch in enumerate(self.train_dataloaders):
                ...
                if self.opt['FAKE_UPDATE'] and self.opt['rank'] == 0:
                    logger.info("{}|{}".format(batch_idx, self.train_params['updates_per_epoch']))
